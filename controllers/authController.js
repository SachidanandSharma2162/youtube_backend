...
module.exports.changeUserPassword = asyncHandler(async (req, res) => {
  try {
    ...
    return res
      .status(201)
      .send("Password changed successfully. You can now login!");
  } catch (error) {
...
module.exports.updateCoverImage = asyncHandler(async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send(
        "Something went wrong while updating cover image, try again later!"
      );
  }
});
...
module.exports.updateAvatar = asyncHandler(async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send("Something went wrong while updating avatar, try again later!");
  }
});
